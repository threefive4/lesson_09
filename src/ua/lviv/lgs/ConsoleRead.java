...
public class ConsoleRead {
            ...
            try {
                switch (sc.next()) {
                    ...
                    case "6": {
                        ...
                        boolean flag = isSeasonPresent(mas2, season);
    ...
    private static boolean isSeasonPresent(Seasons[] mas2, String season) {
        boolean flag = false;
        for (Seasons seasons2 : mas2) {
